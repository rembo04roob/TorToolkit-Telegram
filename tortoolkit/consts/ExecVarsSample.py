try:
    ...
    class ExecVars:
        ...
        API_HASH = "2583b8bdc2ff7e6d4acca21ae33411cd"
        API_ID = 16092439
        BOT_TOKEN = "5565693926:AAGodJL_qbIEULGLdS0HXJSpkKcNgkgkWlk"
        BASE_URL_OF_BOT = "http://68.183.32.74"

        # Edit the server port if you want to keep it default though.
        SERVPORT = 80

        # ALLOWED USERS [ids of user or supergroup] seperate by commas
        ALD_USR = [-1001757762445]
        OWNER_ID = 1993084922
